...
doc = Document()
sec = doc.sections[0]
sec.page_width = 7772400
sec.page_height = 10058400
sec.top_margin = 1440180
sec.bottom_margin = 1080135
sec.left_margin = 1440180
sec.right_margin = 1080135
...
def simple_field(title, instr):
    h(title, 1)
    p("Daftar isi dan daftar gambar diperbarui pada dokumen akhir.", italic=False)
    page()
